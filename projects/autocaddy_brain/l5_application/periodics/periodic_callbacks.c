...
void periodic_callbacks__10Hz(uint32_t callback_count) {
  coordinate_s phone_coordinate = {0};
  // if (ble_module_init_periodic(&phone_coordinate)) {
  //  printf("Phone long:%f and lat:%f\n", phone_coordinate.longitutde, phone_coordinate.latitude);
  //  set_phone_location(phone_coordinate);
  //}
